...
public class CSVOutput implements IOutput {
	...
	public Boolean generateOutput(IAlgorithm syncLab){
		this.syncLab = (SyncLab) syncLab;
		this.frequencies = this.syncLab.getFrequencies();
		this.params = this.syncLab.getInputParams();
